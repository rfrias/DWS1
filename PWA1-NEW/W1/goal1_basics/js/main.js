...
/*	var name = "Rafael";
	var lastName = "Frias";
	var monthOfBirth = "May";
	console.log("Name: " + name + " / Last Name: " + lastName + " / Month of Birth: " + monthOfBirth);*/
    //example 2: variables not defined will = "undefined"
	/*var name, lastName, monthOfBirth;
	console.log("Name: " + name + " / Last Name: " + lastName + " / Month of Birth: " + monthOfBirth);*/
    //example 3: a mix of variables defined and not defined
	/*var name, lastName = "Frias", monthOfBirth;
	console.log("Name: " + name + " / Last Name: " + lastName + " / Month of Birth: " + monthOfBirth);*/
